...
--
-- Host: localhost
-- Generato il: Ott 10, 2014 alle 22:56
...
--
-- Struttura della tabella `drapt_assets`
--

CREATE TABLE `drapt_assets` (
...
--
-- Dump dei dati per la tabella `drapt_assets`
--

INSERT INTO `drapt_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Struttura della tabella `drapt_associations`
--

CREATE TABLE `drapt_associations` (
...
--
-- Struttura della tabella `drapt_banners`
--

CREATE TABLE `drapt_banners` (
...
--
-- Struttura della tabella `drapt_banner_clients`
--

CREATE TABLE `drapt_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Struttura della tabella `drapt_banner_tracks`
--

CREATE TABLE `drapt_banner_tracks` (
...
--
-- Struttura della tabella `drapt_categories`
--

CREATE TABLE `drapt_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dump dei dati per la tabella `drapt_categories`
--

INSERT INTO `drapt_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Struttura della tabella `drapt_contact_details`
--

CREATE TABLE `drapt_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Struttura della tabella `drapt_content`
--

CREATE TABLE `drapt_content` (
...
--
-- Struttura della tabella `drapt_contentitem_tag_map`
--

CREATE TABLE `drapt_contentitem_tag_map` (
...
--
-- Struttura della tabella `drapt_content_frontpage`
--

CREATE TABLE `drapt_content_frontpage` (
...
--
-- Struttura della tabella `drapt_content_rating`
--

CREATE TABLE `drapt_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Struttura della tabella `drapt_content_types`
--

CREATE TABLE `drapt_content_types` (
...
--
-- Dump dei dati per la tabella `drapt_content_types`
--

INSERT INTO `drapt_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Struttura della tabella `drapt_core_log_searches`
--

CREATE TABLE `drapt_core_log_searches` (
...
--
-- Struttura della tabella `drapt_extensions`
--

CREATE TABLE `drapt_extensions` (
...
--
-- Dump dei dati per la tabella `drapt_extensions`
--

INSERT INTO `drapt_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"a1b7cb3de1638137104b94c5544cc2fe"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Struttura della tabella `drapt_finder_filters`
--

CREATE TABLE `drapt_finder_filters` (
...
--
-- Struttura della tabella `drapt_finder_links`
--

CREATE TABLE `drapt_finder_links` (
...
--
-- Struttura della tabella `drapt_finder_links_terms0`
--

CREATE TABLE `drapt_finder_links_terms0` (
...
--
-- Struttura della tabella `drapt_finder_links_terms1`
--

CREATE TABLE `drapt_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_terms2`
--

CREATE TABLE `drapt_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_terms3`
--

CREATE TABLE `drapt_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_terms4`
--

CREATE TABLE `drapt_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_terms5`
--

CREATE TABLE `drapt_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_terms6`
--

CREATE TABLE `drapt_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_terms7`
--

CREATE TABLE `drapt_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_terms8`
--

CREATE TABLE `drapt_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_terms9`
--

CREATE TABLE `drapt_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_termsa`
--

CREATE TABLE `drapt_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_termsb`
--

CREATE TABLE `drapt_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_termsc`
--

CREATE TABLE `drapt_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_termsd`
--

CREATE TABLE `drapt_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_termse`
--

CREATE TABLE `drapt_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_links_termsf`
--

CREATE TABLE `drapt_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Struttura della tabella `drapt_finder_taxonomy`
--

CREATE TABLE `drapt_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dump dei dati per la tabella `drapt_finder_taxonomy`
--

INSERT INTO `drapt_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Struttura della tabella `drapt_finder_taxonomy_map`
--

CREATE TABLE `drapt_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Struttura della tabella `drapt_finder_terms`
--

CREATE TABLE `drapt_finder_terms` (
...
--
-- Struttura della tabella `drapt_finder_terms_common`
--

CREATE TABLE `drapt_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dump dei dati per la tabella `drapt_finder_terms_common`
--

INSERT INTO `drapt_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Struttura della tabella `drapt_finder_tokens`
--

CREATE TABLE `drapt_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Struttura della tabella `drapt_finder_tokens_aggregate`
--

CREATE TABLE `drapt_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Struttura della tabella `drapt_finder_types`
--

CREATE TABLE `drapt_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Struttura della tabella `drapt_languages`
--

CREATE TABLE `drapt_languages` (
...
--
-- Dump dei dati per la tabella `drapt_languages`
--

INSERT INTO `drapt_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Struttura della tabella `drapt_menu`
--

CREATE TABLE `drapt_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dump dei dati per la tabella `drapt_menu`
--

INSERT INTO `drapt_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Struttura della tabella `drapt_menu_types`
--

CREATE TABLE `drapt_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dump dei dati per la tabella `drapt_menu_types`
--

INSERT INTO `drapt_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Struttura della tabella `drapt_messages`
--

CREATE TABLE `drapt_messages` (
...
--
-- Struttura della tabella `drapt_messages_cfg`
--

CREATE TABLE `drapt_messages_cfg` (
...
--
-- Struttura della tabella `drapt_modules`
--

CREATE TABLE `drapt_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dump dei dati per la tabella `drapt_modules`
--

INSERT INTO `drapt_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Struttura della tabella `drapt_modules_menu`
--

CREATE TABLE `drapt_modules_menu` (
...
--
-- Dump dei dati per la tabella `drapt_modules_menu`
--

INSERT INTO `drapt_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Struttura della tabella `drapt_newsfeeds`
--

CREATE TABLE `drapt_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Struttura della tabella `drapt_overrider`
--

CREATE TABLE `drapt_overrider` (
...
--
-- Struttura della tabella `drapt_postinstall_messages`
--

CREATE TABLE `drapt_postinstall_messages` (
...
--
-- Dump dei dati per la tabella `drapt_postinstall_messages`
--

INSERT INTO `drapt_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Struttura della tabella `drapt_redirect_links`
--

CREATE TABLE `drapt_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Struttura della tabella `drapt_schemas`
--

CREATE TABLE `drapt_schemas` (
...
--
-- Dump dei dati per la tabella `drapt_schemas`
--

INSERT INTO `drapt_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.3.6-2014-09-30');

-- --------------------------------------------------------

--
-- Struttura della tabella `drapt_session`
--

CREATE TABLE `drapt_session` (
...
--
-- Dump dei dati per la tabella `drapt_session`
--

INSERT INTO `drapt_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('b2f1661c9c2d462dbd39390f2e8210d8', 0, 1, '1412974275', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1412974274;s:18:"session.timer.last";i:1412974274;s:17:"session.timer.now";i:1412974274;s:22:"session.client.browser";s:120:"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.101 Safari/537.36";s:8:"registry";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"3c89e8739f427e53161e81b75afe04b0";}', 0, '');

-- --------------------------------------------------------

--
-- Struttura della tabella `drapt_tags`
--

CREATE TABLE `drapt_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dump dei dati per la tabella `drapt_tags`
--

INSERT INTO `drapt_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Struttura della tabella `drapt_template_styles`
--

CREATE TABLE `drapt_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dump dei dati per la tabella `drapt_template_styles`
--

INSERT INTO `drapt_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Struttura della tabella `drapt_ucm_base`
--

CREATE TABLE `drapt_ucm_base` (
...
--
-- Struttura della tabella `drapt_ucm_content`
--

CREATE TABLE `drapt_ucm_content` (
...
--
-- Struttura della tabella `drapt_ucm_history`
--

CREATE TABLE `drapt_ucm_history` (
...
--
-- Struttura della tabella `drapt_updates`
--

CREATE TABLE `drapt_updates` (
...
--
-- Struttura della tabella `drapt_update_sites`
--

CREATE TABLE `drapt_update_sites` (
...
--
-- Dump dei dati per la tabella `drapt_update_sites`
--

INSERT INTO `drapt_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
...
--
-- Struttura della tabella `drapt_update_sites_extensions`
--

CREATE TABLE `drapt_update_sites_extensions` (
...
--
-- Dump dei dati per la tabella `drapt_update_sites_extensions`
--

INSERT INTO `drapt_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Struttura della tabella `drapt_usergroups`
--

CREATE TABLE `drapt_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dump dei dati per la tabella `drapt_usergroups`
--

INSERT INTO `drapt_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Struttura della tabella `drapt_users`
--

CREATE TABLE `drapt_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dump dei dati per la tabella `drapt_users`
--

INSERT INTO `drapt_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(560, 'Super User', 'castronu', 'castronu@gmail.com', '$2y$10$aPcaCwHkqEbLmu2V7tJ2TufZhjQAK7s/XrMSqsydrS9jDvXF66aP2', 0, 1, '2014-10-10 20:51:01', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Struttura della tabella `drapt_user_keys`
--

CREATE TABLE `drapt_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Struttura della tabella `drapt_user_notes`
--

CREATE TABLE `drapt_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Struttura della tabella `drapt_user_profiles`
--

CREATE TABLE `drapt_user_profiles` (
...
--
-- Struttura della tabella `drapt_user_usergroup_map`
--

CREATE TABLE `drapt_user_usergroup_map` (
...
--
-- Dump dei dati per la tabella `drapt_user_usergroup_map`
--

INSERT INTO `drapt_user_usergroup_map` (`user_id`, `group_id`) VALUES
(560, 8);

-- --------------------------------------------------------

--
-- Struttura della tabella `drapt_viewlevels`
--

CREATE TABLE `drapt_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dump dei dati per la tabella `drapt_viewlevels`
--

INSERT INTO `drapt_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Struttura della tabella `drapt_weblinks`
--

CREATE TABLE `drapt_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
